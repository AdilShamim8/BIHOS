...
if __name__ == "__main__":
    ...
    print(f"  Skin classes        : {len(SKIN_CLASSES)}")
    print(f"  Dental model loaded : {models['dental']['loaded']}")
    print(f"  Dental classes      : {len(DENTAL_CLASSES)}")
    print(f"  Nail model loaded   : {models['nail']['loaded']}")
    print(f"  Nail classes        : {len(NAIL_CLASSES)}")
    print(f"  Eye model loaded    : {models['eye']['loaded']}")
    print(f"  Eye classes         : {len(EYE_CLASSES)}")
    print(f"  Oral model loaded   : {models['oral']['loaded']}")
    print(f"  Oral classes        : {len(ORAL_CLASSES)}")
